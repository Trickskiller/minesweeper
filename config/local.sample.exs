...
config :minesweeper, Minesweeper.Repo,
  url:
    if(config_env() != :test,
      ...
      do: "ecto://minesweeper:Archidep2022@localhost/minesweeper",
      ...
      else: "ecto://minesweeper:Archidep2022@localhost/minesweeper-test"
    )
...
config :minesweeper, MinesweeperWeb.Endpoint,
  ...
  secret_key_base: "/wggIPhlgQitXDKd65nnn3XDsd2VoLUR6BdNxQq7MaImMn33edo6eJAvRi9oiIDu",
